...
class PsyOptMain(xDSLOptMain):
    ...
    def register_all_passes(self):
        ...
        self.register_pass("apply-stencil-analysis", lambda: ApplyStencilAnalysis)
        self.register_pass("lower-psy-ir", lambda: LowerPsyIR)
        self.register_pass("extract-stencil", lambda: ExtractStencil)
        self.register_pass("rewrite-fir-to-standard", lambda: RewriteFIRToStandard)
        self.register_pass("infer-gpu-data-transfer", lambda: InferGPUDataTransfer)
    ...
    def register_all_dialects(self):
        ...
        self.ctx.load_dialect(psyIR)
        self.ctx.load_dialect(psyStencil)
